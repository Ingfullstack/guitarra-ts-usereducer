...
export default function ListadoGuitarras({ item, dispatch } : Props) {
  return (
    <div className="col-md-6 col-lg-4 my-4 row align-items-center">
      ...
      <div className="col-8">
        ...
        <button onClick={ () => dispatch({ type: "agregar-guitarra", payload: { guitarra: item }})} type="button" className="btn btn-dark w-100">
          Agregar al Carrito
        </button>
      </div>
    </div>
